...
### Parâmetros
path = "resized-160x160"
batch_size_val=32
steps_per_epoch_val=63
epochs_val=20
imageDimesions = (160,160,3)
...
def myModel():
    ...
    model.add(Conv2D(64,kernel_size=(5,5),input_shape=(imageDimesions[0],imageDimesions[1],1),activation='relu'))
    model.add(MaxPooling2D(pool_size=(2,2)))
